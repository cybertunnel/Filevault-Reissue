...
/usr/bin/pkgbuild --root "${dir}/payload" \
	 --scripts "${dir}/scripts" \
	 --identifier com.github.cybertunnel.Filevault-Reissue.Installer \
	 --version ${VERSION} \
	 --component-plist "${dir}/Filevault-Reissue-component.plist" \
	 "${dir}/Filevault-ReissueInstaller-${VERSION}.pkg"
